...
@section('title')
    View Exam Shedule > Teacher Control
@endsection
                    ...
                    @else
                        @foreach ($exam_routine as $qsd)
                            ...
                            <tr class="text-center">
                                ...
                                <td>{{ date('Y M d', strtotime($qsd->exam_date)) }}</td>
                                <td>{{ $qsd->exam_time }}</td>
                                ...
                                <td class="">
                                    <div class="btn-group btn-group-toggle" >
                                        ...
                                        {{-- <input type="radio" name="options" id="option_b1" autocomplete="off" checked> Active --}}
                                            <a href="{{ route('teacherExamShedult.delete', ['id'=>$qsd->id]) }}" class="text" id="delete option_b1">Delete</a>
                                        </label>
                    ...
                    <div class="row mt-2 addQuestionOption">
                        <div class="co-12">
                            <div class="input-group inputOption">
                                <input type="radio" name="is_correct" value="" class="is_correct mr-1">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">
            View Question <br>
            <span class="btn btn-info btn-sm totalQuestion"> </span>
        </h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
                ...
                `
                    <div class="row d-flex">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" id="duration" name="duration" value="${response.data.total_time}" class="form-control">
                        </div> 
                        <div class="col-6 my-2">
                            <label for="for_correct" class="form-label">For Correct (Number):</label>
                            <input type="text" id="for_correct" name="for_correct" value="${response.data.for_correct}" class="form-control">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" id="for_incorrect" name="for_incorrect" value="${response.data.for_incorrect}" class="form-control">
                            <span class="form-text text text-info"> Number must be positive. </span>
                        </div>
                        <div class="col-6">
                            <label for="for_skiped" class="form-label">For Skipped (Number):</label>
                            <input type="text" id="for_skiped" name="for_skiped" value="${response.data.for_skiped}" class="form-control">
                            <span class="form-text text text-info"> Number must be positive. </span>
                        </div>
                    </div>
                `;
    ...
    $('.showQuestions').click(function (e) {
        ...
        axios.get("{{ URL::to('teacher/question/edit') }}", {
            ...
            .then(function (response) {
                ...
                $('.totalQuestion').text( "Total " + questionData.length + " question");
                ...
                function loData(question, index) {
                    // console.log(question.answers);
                            ...
                            <div class="row mb-2"> 
                                <div class="col-12 mb-2">
                                    <div class="input-group">
                                        ...
                                        <span  class='input-group-text bg-info text-light modalQuestionDelete'>
                                        `+question.answers.length + `opt
                                        </span>
                                    </div>
                        ...
                        // console.log(question.answers[index].is_correct);
    ...
    $('#addOption').click(function (e) {
        ...
        `
            <div class="input-group mt-1 inputOption">
                ...
                <input type="text" name="option[]" placeholder="Option" class="form-control" required value="" required>
