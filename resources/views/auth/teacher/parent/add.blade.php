        ...
        <div class="col-md-6">
            <div class="card">
                <div class="w-100 p-2 d-flex justify-content-between">
                    ...
                    <div>
                        <a href="{{route('teacherParent.index')}}" class="btn btn-primary btn-sm ">All Parent</a>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('teacherParent.store') }}" method="post">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <select name="is_role" id="is_role" class="form-control">
                                    <option selected disabled value="1" > PARENT </option>
                                </select>
                            </div>
