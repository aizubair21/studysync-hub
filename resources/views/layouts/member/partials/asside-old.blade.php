            ...
            <div id="navSchedule"
                ...
                <div class="block">
                    ...
                    <a class="px-4 block py-2 " href="{{ route('vendorExamSchedule.create') }}"
                        wire:navigate>My Schedule 
                    </a>

                    <a class="px-4 block py-2 " href="{{ route('vendorExamSchedule.create') }}"
                        wire:navigate>Exam Result 
                    </a>
                    <hr>
                    <a class="px-4 block py-2 " href="{{ route('vendorExamSchedule.create') }}"
                        wire:navigate>Public Exam 
                    </a>
                </div>
            </div>
        </div>
...
{{-- mobile asside  --}}
<div id="mobileAside" class=" flex items-center md:hidden bg-gray-900 w-0 text-white">
    <div class="w-full flex justify-center items-center" style="height:40px">
        ...
        <div>
            <a href="{{route("instructor-dashboard")}}" wire:navigate
                class=" @if(request()->routeIs('student-dashboard')) bg-green-900 text-white @endif block font-normal my-1 text-md text-center">
                <img src="{{asset('media/home-white.png')}}" width="40" class="p-1" alt="">
            </a>
        </div>
        ...
        <div class="m_sidebarItem overflow-hidden cursor-pointer my-1 p-2 hover:bg-gray-300">
            <a wire-navigate href="{{route('vendorQuestions.index')}}" class=" @if(request()->routeIs('vendorQuestions.index')) bg-green-900 text-white @endif font-normal flex items-center justify-start">
                <img width="35" src="{{asset('media/exam-white.png')}}" class="p-1 me-3" alt="">
            </a>
