<div>
    <div class="mb-2">
        ...
        <input type="text" wire:model="new_permission_name" id="new_role"
            class="form-control @error('new_permission_name') is-invalid @enderror" placeholder="permission name">
        ...
        <div class="form-text text text-info">
            ...
            <p>
                If your permission name have more then one word, use underscore (_) instead space. For example
                "write_post".
            </p>
        </div>
    </div>
    <button class="btn btn-md btn-success float-right" data-bs-dismiss="modal" wire:click="addPermission">Save</button>
</div>
