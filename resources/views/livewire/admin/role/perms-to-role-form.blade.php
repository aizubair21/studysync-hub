<div>
  ...
  {{-- assignPermissionToUserModel --}}
    <ul class="nav nav-tabs mt-1" id="myTab" role="tablist">
        ...
        <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">To User</button>
        </li>
        <li class="nav-item" role="presentation">
        <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">To Role</button>
        </li>
    </ul>
    <div class="tab-content" id="myTabContent">
        ...
        {{-- permission to user --}}
            ...
            <hr>
            <button type="button" wire:click="assignPermissionToUser" class="btn btn-md btn-success float-right" data-bs-dismiss="modal" >Save</button>
        ...
        {{-- permission to a role --}}
            ...
            <hr>
            <button type="button" class="btn btn-md btn-success float-right" data-bs-dismiss="modal" wire:click="assingPermissionToRole" >Save</button>
