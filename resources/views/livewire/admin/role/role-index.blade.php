    ...
    <div class="content-wrapper p-2">
        ...
        <div class="row m-0">
            ...
            <div class="col-md-6 text-start  text-md-end">
                <button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#assignRoleModel">
                    <i class="fas fa-link"></i> Assign role </button>
                <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                    data-bs-target="#assignPermissionToUserModel">
                    ...
                    <tr>
                        ...
                        <td class="d-block">
                            <a class="my-2 m-md-0 btn btn-outline-primary btn-sm d-block" wire:navigate
                                href="{{ route('adminRole.edit', [$rol->id]) }}"> <i class="fas fa-eye"></i> Quick
                                Edit</a>
        ...
        {{-- role to user --}}
        <div class="modal" id="assignRoleModel" tabindex="-1" aria-labelledby="assignRoleModellLabel"
            aria-hidden="true">
