        ...
        <tbody>
            @foreach ($rols as $id => $rol)
                ...
                <tr>
                    ...
                    <td class="d-block">
                    <a  class="my-2 m-md-0 btn btn-outline-primary btn-sm d-block" wire:navigate href="{{route("adminRole.edit", [$rol->id])}}"> <i class="fas fa-eye"></i> Quick Edit</a>
                    <button type="button" class="my-2 m-md-0 btn btn-info btn-sm my-1" > <i class="fas fa-users"></i> Users</button>
