<div>
    ...
    <div class="p-4">
        ...
        <div class="flex items-center justify-center border-b">
            <button class="px-6 py-2 bg-green-50 text-green-900 font-bold border-b-4 border-green-900">
               <div class="live_animation mr-3"></div> Live Now
            </button>
            <button class="px-6 py-2">Schedule</button>
        </div>
