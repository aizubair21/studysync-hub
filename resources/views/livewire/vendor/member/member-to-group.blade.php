        ...
        <div style="max-width: 650px; width:100%; ">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <select wire:model="memberGroup" id="memberGroup" class="form-control form-select"
                        x-model="memberGroup">
            ...
            {{-- if select a gorup  --}}
            <div class="card" x-show="memberGroup" x-transition>
                <div class="card-header">
                    Attached member
                </div>
                <div class="card-body">
                ...
                <div class="card-footer">
                    <button class="btn btn-success btn-md float-right" type="button" wire:navigate.attr="disabled"
                        wire:click="save"> <i class="fas fa-save me-2"></i> Save </button>
                </div>
            </div>
